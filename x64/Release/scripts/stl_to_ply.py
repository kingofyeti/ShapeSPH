...
# Input folder: '../data_in'
# Output all stl to ply with the same name under the same dir_list
# Output on dir_list.txt file with all output file name listed e.g. ./abc as ./abc.ply and ./abc.stl
